...
const IndexPage = () => {
	return (
		<main className="landing-page">
			...
			<div className="container">
				<div className="row align-items-stretch">
					<div className="col-12 col-md-6 mb-2 mb-md-0">
						<div className="s-card-expanded">
							<h3 className="s-card-expanded__header">Pinglue</h3>
							<div className="s-card-expanded__body" style={{ flex: '1 0 auto' }}>
								<p>
									Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
								</p>
							</div>
							<div className="s-card-expanded__footer">
								<button className="s-btn">Read document</button>
							</div>
						</div>
					</div>
					<div className="col-12 col-md-6 mb-2 mb-md-0">
						<div className="s-card-expanded mb-2 mb-md-0">
			...
			<div style={{ marginTop: '-100px', paddingTop: '150px', background: '#1f2937', paddingBottom: '80px', color: '#9ca3af' }}>
			...
			<div className="container my-5">
				<div className="text-center mb-3">
					<h4 className="mb-hq" style={{color: '#3a87c6'}}>WHY PINGLUE?</h4>
